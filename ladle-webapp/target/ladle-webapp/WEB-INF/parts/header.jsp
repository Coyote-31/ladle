							...
							<div class="form-row">
								...
								<div class="col-12 col-sm">
									<div class="form-group">
										<label for="headerInputEmail">Email</label> <input type="email"
											class="form-control form-control-sm" id="headerInputEmail"
								...
								<div class="col-12 col-sm">
									<div class="form-group">
										<label for="HeaderInputPassword">Password</label> <input type="password"
											class="form-control form-control-sm" id="HeaderInputPassword"
							...
							<div class="form-row">
								...
								<div class="col">
									<div class="form-group form-check">
										<input type="checkbox" class="form-check-input" id="HeaderCheckStayConnected"> <label
											class="form-check-label" for="HeaderCheckStayConnected">Rester connecté</label>
									</div>
								</div>
