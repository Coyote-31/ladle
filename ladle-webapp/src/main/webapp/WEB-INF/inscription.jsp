    ...
    <form method="post" action="inscription">
      <fieldset>
        ...
        <c:if test="${validationList['genreValid'] == 0 && validationList['genreEmpty'] == 1}">
          <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Erreur de genre !</strong> Veuillez sélectionner Madame ou Monsieur.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
              aria-hidden="true">&times;</span></button>
          </div>
        </c:if>
        ...
        <c:if test="${validationList['prenomEmpty'] == 0}">
          <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Erreur de prénom !</strong> Ce champ ne peut pas être vide.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
              aria-hidden="true">&times;</span></button>
          </div>
        </c:if>
        ...
        <c:if test="${validationList['mdpLength'] == 0}">
          <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Erreur de mot de passe !</strong> Doit contenir entre 8 et 40 caratères.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
              aria-hidden="true">&times;</span></button>
          </div>
        </c:if>
        ...
        <c:if test="${validationList['mdpEquals'] == 0}">
          <div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>Erreur de mot de passe !</strong> Les mots de passe doivent être identiques.
            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
              aria-hidden="true">&times;</span></button>
          </div>
        </c:if>
